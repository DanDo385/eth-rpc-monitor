// Package display provides terminal formatting helpers and shared result types.
//
// Commands keep their runtime logic in cmd/ while delegating presentation concerns here.
package display
